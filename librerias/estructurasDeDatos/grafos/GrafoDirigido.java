...
/** Clase GrafoD: Implementacion de un grafo Dirigido (Ponderado o no) mediante Listas de Adyacencia.<br>
 * 
 * @version Mayo 2012
 */
public class GrafoDirigido extends Grafo { 
    ...
    public GrafoDirigido(int numVertices){
        ...
        for (int i=0; i<numV; i++) elArray[i]= new LEGListaConPI<Adyacente>();
    }
    ...
    /** Si no esta, inserta la arista (i, j) en un grafo no Ponderado (al principio de la Lista de adyacentes a i).
      * @param i    Vertice origen
      * @param j    Vertice destino
      */       
    public void insertarArista(int i, int j) {
        if ( !existeArista(i,j) ) { elArray[i].insertar(new Adyacente(j,1)); numA++; }
    }

    /** Si no esta, inserta la arista (i, j) de peso p en un grafo Ponderado (al principio de la Lista de adyacentes a i).
      * @param i    Vertice origen
      * @param j    Vertice destino
      * @param p    Peso de (i, j)
      */  
